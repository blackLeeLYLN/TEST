...
public class Schema
{
	...
	public static final class Uri
	{
		...
		public java.io.InputStream getReader(Context context) throws Exception
		{
			return FileSystem.getReader(context, this);
		}
		
		public OutputStream getWriter(Context context) throws Exception
		{
			OutputStream writer = FileSystem.getWriter(context, this);
			return writer;
		}
		...
		public File getFile(Context context)
		{
	        ...
	        if (this.type == Schema.URI_FILE)
	        {
	    		...
	    		if (fPath.indexOf('/') > -1)
	    			...
	    			fPath = "";
	    		File dir = new File(root + File.separator + context.getPackageName() + File.separator);
